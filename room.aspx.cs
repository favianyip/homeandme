...
public partial class room : System.Web.UI.Page
{
        ...
        try
        {
            ...
            }
            {
                ...
                SQLContainer.Query = @"SELECT Scopes_in_ProjectRooms.ThemeID FROM Scopes_in_ProjectRooms 
                                        ...
                                        WHERE Scopes_in_ProjectRooms.IsActive = 1 AND Scopes_in_ProjectRooms.RoomPreferenceID = " + Session["RoomPreferenceID"].ToString() 
                                        + " AND RoomPreference.RoomID = " + Session["RoomID"].ToString();
                List<SqlParameter> SqlParameters = new List<SqlParameter>();
                SQLCommands.Add(SQLContainer);
            }
            if (!Tools.GetData(SQLCommands, out DS, out ErrorIfAny))
        ...
        try
        {
            ...
            if (Session["ProjectID"] != null && Session["ProjectID"] != "")
            {
                ...
                else
                {
                    ...
                    {
                        TotalRate = "0";
                        lblRoomTotalCost.Text = "0";
                        lblWHRoomTotalCost.Text = "0";
    ...
    protected void lnkActiveRoom_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ScriptManager.RegisterStartupScript(Page, Page.GetType(), "scrollDown", "setTimeout(function () { window.scrollTo(0,900); }, 5000);", true);

            // ScriptManager.RegisterStartupScript(this, GetType(), "class", "FocusThms();", true);
    ...
    protected void ibScope_Click(object sender, ImageClickEventArgs e)
    {
        ...
        CheckRenovation();
        ActiveSelection();
        divOptionItems.Focus();
        ScriptManager.RegisterStartupScript(Page, Page.GetType(), "scrollDown", "setTimeout(function () { window.scrollTo(0,1300); }, 5000);", true);
    ...
    protected void lnkOption_Click(object sender, EventArgs e)
    {
        ...
        ActiveSelection();
        dvSubOptItm.Focus();
        ScriptManager.RegisterStartupScript(Page, Page.GetType(), "scrollDown", "setTimeout(function () { window.scrollTo(0,1000); }, 5000);", true);
    ...
    protected void ibSubOption_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            LoadSubsubOptionL3();
            ActiveSelection();
            dvSubSubOptItm.Focus();
            ScriptManager.RegisterStartupScript(Page, Page.GetType(), "scrollDown", "setTimeout(function () { window.scrollTo(0,2000); }, 5000);", true);
    ...
    protected void ibSubsubOption_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            ActiveSelection();
            dvSubSubOptL2.Focus();
            ScriptManager.RegisterStartupScript(Page, Page.GetType(), "scrollDown", "setTimeout(function () { window.scrollTo(0,2500); }, 5000);", true);
    ...
    protected void ibSubsubOptionl2_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            ActiveSelection();
            dvSubSubOptL3.Focus();
            ScriptManager.RegisterStartupScript(Page, Page.GetType(), "scrollDown", "setTimeout(function () { window.scrollTo(0,3000); }, 5000);", true);
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ScriptManager.RegisterStartupScript(Page, Page.GetType(), "scrollDown", "setTimeout(function () { window.scrollTo(0,35000); }, 5000);", true);
    ...
    protected void ibWHScope_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                ScriptManager.RegisterStartupScript(Page, Page.GetType(), "scrollDown", "setTimeout(function () { window.scrollTo(0,950); }, 5000);", true);
    ...
    protected void lnkWHOptions_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ScriptManager.RegisterStartupScript(Page, Page.GetType(), "scrollDown", "setTimeout(function () { window.scrollTo(0,1500); }, 5000);", true);
