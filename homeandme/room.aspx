<%@ Page Title="" Language="C#" MaintainScrollPositionOnPostback="false" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="room.aspx.cs" Inherits="room" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script>
        ...
        function ChangeThemeClass(a) {
            debugger;
            var id = "divTheme" + a;
            //if (document.getElementById(id).classList[1] == 'active') {
        ...
        function ShowInvalidDataAlertModal() {
            debugger;
            document.getElementById("InvalidDataModal").style.display = "block";
            document.getElementById("InvalidDataModal").classList.remove("fade")
        }
        function CloseInvalidDataAlertModal() {
            debugger;
            document.getElementById("InvalidDataModal").style.display = "none";
            document.getElementById("InvalidDataModal").classList.add("fade")
        }
        ...
        function CloseThemeModal() {
            ...
            document.getElementById("divModalBottom").classList.remove("fade");
            document.getElementById("divModalBottom").classList.remove("modal-backdrop");
        }
        function showLoder() {
            window.scrollTo(0, 0);
            document.getElementById("divLoader").classList.add('active');
        }
        function hideLoader() {

            document.getElementById("divLoader").classList.remove('active');
        }
        ...
        function FocusThms() {
            ...
            window.location.hash = '#divTH';
        }

        function FocusScopeItms() {
            debugger;
            //showLoder();
            document.getElementById("dvScopItm").focus();
            document.getElementById("dvScopItm").scrollTop =
                document.getElementById("dvScopItm").scrollHeight;
        }

        function FocusScopeOptItms() {
            debugger;
            //showLoder();
            document.getElementById("dvScopOptItm").focus();
            document.getElementById("dvScopOptItm").scrollTop =
                document.getElementById("dvScopOptItm").scrollHeight;
        }

        function FocusSubOptItms() {
            debugger;
            //showLoder();
            document.getElementById("dvSubOptItm").focus();
            document.getElementById("dvSubOptItm").scrollTop =
                document.getElementById("dvSubOptItm").scrollHeight;
        }

        function FocusSubSubOptItms() {
            debugger;
            //showLoder();
            document.getElementById("dvSubSubOptItm").focus();
            document.getElementById("dvSubSubOptItm").scrollTop =
                document.getElementById("dvSubSubOptItm").scrollHeight;
        }


        function FocusSubSubOptL2() {
            debugger;
            //showLoder();
            document.getElementById("dvSubSubOptL2").focus();
            document.getElementById("dvSubSubOptL2").scrollTop =
                document.getElementById("dvSubSubOptL2").scrollHeight;
        }


        function FocusSubSubOptL3() {
            debugger;
            //showLoder();
            document.getElementById("dvSubSubOptL3").focus();
            document.getElementById("dvSubSubOptL3").scrollTop =
                document.getElementById("dvSubSubOptL3").scrollHeight;
        }
    </script>
    <script>
        debugger;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <%--<asp:UpdatePanel runat="server" UpdateMode="Always">
        <ContentTemplate>--%>
    <div style="min-height: calc(100vh - 169px );" id="dvRoomCnt" runat="server" clientidmode="static">
        ...
        <div class="content-wrapper hnm-prefer hnm-r-pb-5">
            <div class="hnm-prefer__inner grey-box">
                <div class="hnm-prefer__title-sec">
                    <h2 class="grey-box__title"><b>Add the room types </b>
                        <b>
                            <asp:Literal ID="litMsg" Visible="false" Text="> Click a room icon to customize" runat="server"></asp:Literal></b></h2>
                </div>
                        ...
                        <ItemTemplate>
                            <div class='<%# Eval("RoomDivClass") %> '>
                                <div class="hnm-icon-round">
                                    ...
                                    <div class='<%# Eval("RoomDivClass").ToString() == "hnm-room-tile active complete"?"hnm-load d-none" :"hnm-load" %> '>
                            ...
                            <img src="../assets/images/close-icon-grey-round.svg" alt=""></asp:LinkButton>
                                <asp:LinkButton ID="lnkActiveRoom" OnClientClick=" showLoder();" runat="server" OnClick="lnkActiveRoom_Click" Style="position: absolute; inset: 0;" CommandArgument='<%# Eval("RoomPreferenceID") %>' CommandName='<%# Eval("RoomID") %>'>
                                </asp:LinkButton>
                            </div>
                        </ItemTemplate>
                    </asp:Repeater>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <asp:SqlDataSource ID="RoomTypeSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                                    SelectCommand="SELECT RoomID, RoomName FROM Rooms WHERE IsActive = 1  ORDER BY SortOrder ASC"></asp:SqlDataSource>
                                ...
                                <ItemTemplate>
                                    <div class="hnm-icon-round" id='<%# "divWHScope" + DataBinder.Eval(Container.DataItem, "ScopeID")  %>'>
                                        <asp:ImageButton ID="ibWHScope" runat="server" CssClass="hnm-icon-round__img" ImageUrl='<%# Convert.ToString(Convert.ToString(Eval("ScopeID")) == Convert.ToString(Session["WHScopeID"]) ? Eval("ImageUrl2") : Eval("ImageUrl"))  %>' CommandArgument='<%# Eval("ScopeID") %>'
                                            OnClientClick="showLoder();" OnClick="ibWHScope_Click" />
                        ...
                        <div class="hnm-box-head__cnt">
                                    ...
                                    <asp:Repeater runat="server" ID="rptWHOptions">
                                        <ItemTemplate>
                                            <div id='<%# "divWHOption" + DataBinder.Eval(Container.DataItem, "WHOptionID")  %>' class="hnm-border-box">
                                                <asp:LinkButton ID="lnkWHOptions" runat="server" CommandArgument='<%# Eval("WHOptionID") %>'
                                                    OnClientClick="showLoder();" OnClick="lnkWHOptions_Click"><%# Eval("WHOptionName") %></asp:LinkButton>
                                            </div>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                </div>
                            ...
                            <div>
                                <div class="hnm-custom-item__flex-btw" style="padding-right: 30px !important;" id="divWHSave" runat="server" visible="false">
                                    <asp:Button ID="btnWHSave" OnClientClick="showLoder();" runat="server" CssClass="hnm-button" Text="Save" OnClick="btnWHSave_Click" />
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div id="divNotWholeApartment" runat="server" visible="false">
            <div class="hnm-config-room hnm-r-pb-5" id="divRoomThemes" runat="server" visible="false">
                <div class="content-wrapper">
                    ...
                    <div class="hnm-box-head" id="dvThms" runat="server">
                        ...
                        <div class="hnm-box-head__cnt">
                                ...
                                <asp:Repeater runat="server" ID="rptRoomThemes">
                                    <ItemTemplate>
                                        <div class="hnm-design-tile" id='<%# "divTheme" + DataBinder.Eval(Container.DataItem, "ThemeID")  %>'>
                                            ...
                                            <asp:LinkButton ID="lnkTheme" runat="server" CssClass="hnm-check-box" OnClick="lnkTheme_Click"
                                                OnClientClick="showLoder();" CommandName='<%# Eval("ThemeID") %>' CommandArgument='<%# Eval("ThemeID") %>'>
                                        <span><%# Eval("ThemeName") %></span>
                                         <span class="hnm-check-box__check"></span>
                                               <%-- <asp:CheckBox ID="chktype" class="hnm-check-box__check" runat="server" />--%>
                                            </asp:LinkButton>
                                        </div>
                                    </ItemTemplate>
                                </asp:Repeater>
                            ...
                            <div id="divTH" runat="server" clientidmode="static"></div>
                        </div>
                    </div>
            ...
            <div class="hnm-custom-tab hnm-r-pb-5" id="divScopeItems" runat="server" visible="false">
                <div class="content-wrapper">
                    <div class="grey-box">
                        <h2 class="grey-box__title">Please select the following items you want to customise.</h2>
                        <div class="hnm-custom-tab__outer hnm-custom-tab__slider" id="dvScopItm" runat="server" clientidmode="static">
                                ...
                                <ItemTemplate>
                                    <div class="hnm-icon-round" id='<%# "divScope" + DataBinder.Eval(Container.DataItem, "ScopeID")  %>'>
                                        <asp:ImageButton ID="ibScope" runat="server" CssClass="hnm-icon-round__img" ImageUrl='<%# Convert.ToString(Convert.ToString(Eval("ScopeID")) == Convert.ToString(Session["ScopeID"]) ? Eval("ImageUrl2") : Eval("ImageUrl"))  %>' CommandArgument='<%# Eval("ScopeID") %>'
                                            OnClientClick="showLoder();" OnClick="ibScope_Click" />
                                        <p class="hnm-icon-round__text"><%# Eval("Scope") %></p>
                                    </div>
                                </ItemTemplate>
                            </asp:Repeater>
                    ...
                    <div class="hnm-box-head">
                        ...
                        <div class="hnm-box-head__cnt">
                            ...
                            <div class="hnm-custom-item__material" id="divOption" runat="server">
                                ...
                                <div class="hnm-custom-item__tab hnm-custom-item__tab-slider" id="dvScopOptItm" runat="server" clientidmode="static">
                                    <asp:Repeater runat="server" ID="rptOptions">
                                        <ItemTemplate>
                                            <div id='<%# "divOption" + DataBinder.Eval(Container.DataItem, "OptionID")  %>' class="hnm-border-box">
                                                <asp:LinkButton ID="lnkOptions" runat="server" CommandArgument='<%# Eval("OptionID") %>'
                                                    OnClientClick="showLoder();" OnClick="lnkOptions_Click"><%# Eval("Option") %></asp:LinkButton>
                                            </div>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                </div>
                        ...
                        <img alt="" src="assets/images/checked-icon.png" style="width: 20px; height: auto;" />
                            ...
                            <div class="hnm-custom-item__texture" id="divSubOptionItems" runat="server" visible="false">
                                ...
                                <div class="hnm-custom-item__slider hnm-custom-item__texture-slider" id="dvSubOptItm" runat="server" clientidmode="static">
                                            ...
                                            <div class="hnm-texture-tile" id='<%# "divSubOption" + DataBinder.Eval(Container.DataItem, "SubOptionID")  %>'>
                                                <div class="hnm-texture-tile__img-sec">
                                                    <asp:ImageButton ID="ibSubOption" runat="server" CssClass="hnm-texture-tile__img" ImageUrl='<%# Eval("ImageUrl") %>' CommandArgument='<%# Eval("SubOptionID") %>'
                                                        OnClientClick="showLoder();" OnClick="ibSubOption_Click" />
                                                </div>
                            ...
                            <div class="hnm-custom-item__size" id="divSubSubOptionItems" runat="server" visible="false">
                                ...
                                <div class="hnm-custom-item__slider hnm-custom-item__size-slider" id="dvSubSubOptItm" runat="server" clientidmode="static">
                                    <asp:Repeater runat="server" ID="rptSubSubOption">
                                        <ItemTemplate>
                                            <div class="hnm-texture-tile" id='<%# "divSubsubOption" + DataBinder.Eval(Container.DataItem, "SubsubOptionID")  %>'>
                                                <div class="hnm-texture-tile__img-sec">
                                                    <asp:ImageButton ID="ibSubsubOptL2" runat="server" CssClass="hnm-texture-tile__img" ImageUrl='<%# Eval("ImageUrl") %>' CommandArgument='<%# Eval("SubsubOptionID") %>'
                                                        OnClientClick="showLoder();" OnClick="ibSubsubOption_Click" />
                                                </div>
                            ...
                            <div class="hnm-custom-item__size" id="divSubSubOptionL2Items" runat="server" visible="false">
                                ...
                                <p class="hnm-box-head__cnt-head">Please select the item.</p>
                                <div class="hnm-custom-item__slider hnm-custom-item__size-slider" id="dvSubSubOptL2" runat="server" clientidmode="static">
                                            ...
                                            <div class="hnm-texture-tile" id='<%# "divSubsubOptionL2" + DataBinder.Eval(Container.DataItem, "SubsubOptionL2ID")  %>'>
                                                <div class="hnm-texture-tile__img-sec">
                                                    <asp:ImageButton ID="ibSubsubOptionl2" runat="server" CssClass="hnm-texture-tile__img" ImageUrl='<%# Eval("ImageUrl") %>' CommandArgument='<%# Eval("SubsubOptionL2ID") %>'
                                                        OnClientClick="showLoder();" OnClick="ibSubsubOptionl2_Click" />
                                                </div>
                            ...
                            <div class="hnm-custom-item__size" id="divSubSubOptionL3Items" runat="server" visible="false">
                                ...
                                <p class="hnm-box-head__cnt-head">Please select the item.</p>
                                <div class="hnm-custom-item__slider hnm-custom-item__size-slider" id="dvSubSubOptL3" runat="server" clientidmode="static">
                                            ...
                                            <div class="hnm-texture-tile" id='<%# "divSubSubOptionL3" + DataBinder.Eval(Container.DataItem, "SubsubOptionL3ID")  %>'>
                                                <div class="hnm-texture-tile__img-sec">
                                                    <asp:ImageButton ID="ibSubsubOptionL3" runat="server" CssClass="hnm-texture-tile__img" ImageUrl='<%# Eval("ImageUrl") %>' CommandArgument='<%# Eval("SubsubOptionL3ID") %>'
                                                        OnClientClick="showLoder();" OnClick="ibSubsubOptionL3_Click" />
                                                </div>
                                            ...
                                            <div class="hnm-custom-item__area-outer">
                                                <div class="hnm-custom-item__area-inner" id="DivLength" runat="server" visible="false">
                                                    <div class="hnm-custom-item__unit">
                                                        ...
                                                        <asp:FilteredTextBoxExtender ID="fteLength" runat="server" TargetControlID="txtLength" ValidChars=".0123456789"></asp:FilteredTextBoxExtender>
                                                    </div>
                                                ...
                                                <div class="hnm-custom-item__area-inner" id="DivWidth" runat="server">
                                                    <div class="hnm-custom-item__unit">
                                                        ...
                                                        <asp:FilteredTextBoxExtender ID="fteWidth" runat="server" TargetControlID="txtWidth" ValidChars=".0123456789"></asp:FilteredTextBoxExtender>
                                                    </div>
                                                ...
                                                <div class="hnm-custom-item__area-inner" id="DivArea" runat="server">
                                                    <div class="hnm-custom-item__unit">
                                                        ...
                                                        <asp:FilteredTextBoxExtender ID="fteArea" runat="server" TargetControlID="txtArea" ValidChars=".0123456789"></asp:FilteredTextBoxExtender>
                                                    </div>
                                                ...
                                                <div class="hnm-custom-item__area-inner" id="DivQuantity" runat="server">
                                                    <div class="hnm-custom-item__unit">
                                                        ...
                                                        <asp:TextBox ID="txtQuantity" runat="server" CssClass="hnm-custom-item__area-input" OnTextChanged="txtQuantity_TextChanged"></asp:TextBox>
                                                        <asp:FilteredTextBoxExtender ID="fteQuantity" runat="server" TargetControlID="txtQuantity" ValidChars=".0123456789"></asp:FilteredTextBoxExtender>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="hnm-custom-item__area-outer">
                                                <div class="hnm-custom-item__area-inner" id="divDCLength" runat="server" visible="false">
                                                    <div class="hnm-custom-item__unit">
                                                        ...
                                                        <asp:FilteredTextBoxExtender ID="fteDCLength" runat="server" TargetControlID="txtDCLength" ValidChars=".0123456789"></asp:FilteredTextBoxExtender>
                                                    </div>
                                                    <div class="hnm-custom-item__unit">
                                                        <p class="hnm-custom-item__unit-text">
                                            ...
                                            <asp:Label ID="lblDCLengthmm" runat="server"></asp:Label>
                                                ...
                                                <div class="hnm-custom-item__area-inner" id="divDCWidth" runat="server">
                                                    <div class="hnm-custom-item__unit">
                                                        ...
                                                        <asp:FilteredTextBoxExtender ID="fteDCWidth" runat="server" TargetControlID="txtDCWidth" ValidChars=".0123456789"></asp:FilteredTextBoxExtender>
                                                    </div>
                                                    <div class="hnm-custom-item__unit">
                                                        <p class="hnm-custom-item__unit-text">
                                                ...
                                                <div class="hnm-custom-item__area-inner" id="DivDCHeight" runat="server">
                                                    <div class="hnm-custom-item__unit">
                                                        ...
                                                        <asp:FilteredTextBoxExtender ID="fteDCHeight" runat="server" TargetControlID="txtDCHeight" ValidChars=".0123456789"></asp:FilteredTextBoxExtender>
                                                    </div>
                                                    <div class="hnm-custom-item__unit">
                                                        <p class="hnm-custom-item__unit-text">
                                                ...
                                                <div class="hnm-custom-item__area-inner" id="DivDCTickness" runat="server">
                                                    <div class="hnm-custom-item__unit">
                                                        ...
                                                        <asp:FilteredTextBoxExtender ID="ftetxtDCThickness" runat="server" TargetControlID="txtDCThickness" ValidChars=".0123456789"></asp:FilteredTextBoxExtender>
                                                    </div>
                                                    <div class="hnm-custom-item__unit">
                                                        <p class="hnm-custom-item__unit-text">
                                                ...
                                                <div class="hnm-custom-item__area-inner" id="divDCQuantity" runat="server">
                                                    <div class="hnm-custom-item__unit">
                                                        ...
                                                        <asp:FilteredTextBoxExtender ID="fteDCQuantity" runat="server" TargetControlID="txtDCQuantity" ValidChars=".0123456789"></asp:FilteredTextBoxExtender>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="hnm-custom-item__select">
                                ...
                                <div class="hnm-custom-item__flex-btw">
                                    ...
                                    <asp:Button ID="btnSave" OnClientClick="showLoder();" runat="server" CssClass="hnm-button" Text="Save" OnClick="btnSave_Click" />
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal fade" id="InvalidDataModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" style="pointer-events: auto !important;">
                <div class="modal-content" style="pointer-events: auto !important;">
                    <div class="grey-box grey-box--centered">
                        <h1 class="hnm-main-head">Please give the valid data</h1>
                        <asp:Button ID="btnValidPopUpClose" runat="server" class="hnm-button" Style="margin-right: 40%; margin-left: 40%; width: 20%" Text="OK" OnClick="btnValidPopUpClose_Click" />
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="modal-body">
                                ...
                                <div id="divimgslidernav" class="hnm-img-slider__nav">
                                    <asp:Repeater ID="rptSliderNav" runat="server">
                                        <ItemTemplate>
                                            <div class="hnm-img-slider__nav-item">
                                                <img src='<%# Eval("Thumbnail") %>' alt="" />
                                            </div>
                                        </ItemTemplate>
                                    </asp:Repeater>
        ...
        <asp:Label ID="lblFocus" Visible="false" runat="server" Text="Label"></asp:Label>
    </div>
    <div id="divLoader" class="hnm-loader"  clientIDMode="static" runat="server">
        <div>
            <p>Please wait...</p>
            <img src="assets/images/busy.gif" alt="">
        </div>
    </div>
    <%--<div class="hnm-loader" id="divLoader" clientIDMode="static" runat="server">
