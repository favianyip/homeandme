...
public partial class CustomizeRoomTest : System.Web.UI.Page
{
        ...
        try
        {
            ...
            else
            {
                if (DS.Tables[0].Rows.Count > 0)
                {
                    ...
                    //        SQLContainerImg.Query = "GetThemeImagesByID @ThemeID";
                    //        List<SqlParameter> SqlParametersImg = new List<SqlParameter>();
                    //        SqlParametersImg.Add(new SqlParameter("ThemeID", DS.Tables[0].Rows[i]["ThemeID"]));
                    ...
                    //            sbImageSlider.Append("<div class='modal fade hnm-img-slider' id='imgSlider" + Convert.ToString(DS.Tables[0].Rows[i]["ThemeID"]) + "'"
                    ...
                    //                                    + "</button>"
                    //                                    + "<div class='hnm-img-slider__for'>");
                    //            for (int j = 0; j <= ds.Tables[0].Rows.Count - 1; j++)
                    //            {
                    //                sbImageSlider.Append("<div class='hnm-img-slider__for-item zoom-box'>"
                    //                                        + "<img src='" + Convert.ToString(ds.Tables[0].Rows[j]["Thumbnail"]) + "' alt='' />"
                    //                                        + "</div>");
                    //            }
                    //            sbImageSlider.Append("</div>"
                    //                                    + "<div class='hnm-img-slider__nav'>");

                    //            for (int j = 0; j <= ds.Tables[0].Rows.Count - 1; j++)
                    //            { 
                    //                if(j == 0)
                    //                {
                    //                    sbImageSlider.Append("<div class='hnm-img-slider__nav-item zoomThumbActive'>");
                    //                }
                    //                else
                    //                {
                    //                    sbImageSlider.Append("<div class='hnm-img-slider__nav-item'>");
                    //                }
                    //                sbImageSlider.Append("<img src='" + Convert.ToString(ds.Tables[0].Rows[j]["Thumbnail"]) + "' alt='' />"
                    //                                        + "</div>");
                    //            }
                    //            sbImageSlider.Append("</div>"
                    //                                   + "</div>"
                    ...
                    //            //for (int j = 0; j <= ds.Tables[0].Rows.Count - 1; j++)
                    //            //{
                    //            //    //sbImageSlider.Append("<div class='hnm-img-slider__for-item' style='background-image:url(" + Convert.ToString(ds.Tables[0].Rows[j]["Thumbnail"]) + ");'></div>");
                    //            //    sbImageSlider.Append("<img class='hnm-img-slider__for-item' src='" + Convert.ToString(ds.Tables[0].Rows[j]["Thumbnail"]) + "' >");
                    //            //}
                    //            //sbImageSlider.Append("</div>"
                    //            //                        + "<div class='hnm-img-slider__nav'>");
                    //            //for (int k = 0; k <= ds.Tables[0].Rows.Count - 1; k++)
                    //            //{
                    //            //    //sbImageSlider.Append("<div class='hnm-img-slider__nav-item' style='background-image:url(" + Convert.ToString(ds.Tables[0].Rows[k]["Thumbnail"]) + ");'></div>");
                    //            //    sbImageSlider.Append("<img class='hnm-img-slider__nav-item' src='" + Convert.ToString(ds.Tables[0].Rows[k]["Thumbnail"]) + "' >");
                    //            //}
                    //            //sbImageSlider.Append("</div>"
                    //            //                        + "</div>"
                    //            //                        + "</div>"
                    ...
                    //            litThemeImageSilderPopUp.Text = litThemeImageSilderPopUp.Text + sbImageSlider.ToString();
                    //        }
                    //    }
                    //}
                }
    ...
    protected void lnkDeleteRoom_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                Tools.SqlContainer SQLContainer = new Tools.SqlContainer();
                SQLContainer.Query = "UPDATE RoomPreference SET IsActive = 0 WHERE RoomPreferenceID = @RoomPreferenceID";
                List<SqlParameter> SqlParameters = new List<SqlParameter>();
        ...
        try
        {
            ...
            else
            {
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    //txtArea.Text = Convert.ToString(Convert.ToInt32(ds.Tables[0].Rows[0]["Length"]) * Convert.ToInt32(ds.Tables[0].Rows[0]["Width"]));
                    //txtQuantity.Text = Convert.ToString(ds.Tables[0].Rows[0]["Quantity"]);
                    //txtDCLength.Text = Convert.ToString(ds.Tables[0].Rows[0]["DCLength"]);
                    //txtDCWidth.Text = Convert.ToString(ds.Tables[0].Rows[0]["DCWidth"]);
                    //txtDCHeight.Text = Convert.ToString(ds.Tables[0].Rows[0]["DCHeight"]);
                    //txtDCThickness.Text = Convert.ToString(ds.Tables[0].Rows[0]["DCThickness"]);
                    //txtDCQuantity.Text = Convert.ToString(ds.Tables[0].Rows[0]["DCQuantity"]);
                }
                else
                {
    ...
    public void LoadAddOns()
    {
        ...
        //{
        //    Tools.SqlContainer SQLContainer = new Tools.SqlContainer();
        //    SQLContainer.Query = @"SELECT Options.OptionID,[Option] FROM Scopes_in_Renovations
        //                           INNER JOIN Options ON Options.OptionID = Scopes_in_Renovations.OptionID
        //                           WHERE RenovationID = " + Session["RenovationID"].ToString() + " AND Options.ScopeID = " + Session["ScopeID"].ToString() + " AND SystemAddOn = 1";
        //    List<SqlParameter> SqlParameters = new List<SqlParameter>();
        //    SQLCommands.Add(SQLContainer);
        //}
        if (!Tools.GetData(SQLCommands, out DS, out ErrorIfAny))
        ...
        else
        {
            ...
            if (DS.Tables[0].Rows.Count > 0)
            {
                //divOptionAddsOn.Visible = true;
                //divOptionAddsOnHead.Visible = true;
                ...
                //    {
                //        foreach (RepeaterItem rptItem in rptAddOns.Items)
                //        {
                //            CheckBox ChkAddOn = (CheckBox)rptItem.FindControl("ChkAddOn");
                //            HiddenField HdnOptionID = (HiddenField)rptItem.FindControl("OptionVal");
                //            if (HdnOptionID.Value == Dr["OptionID"].ToString())
                //            {
                //                ChkAddOn.Checked = true;
                //            }
                //        }
                //    }
                //}
    ...
    public void LoadOptions()
    {
        ...
        //{
        //    Tools.SqlContainer SQLContainer = new Tools.SqlContainer();
        //    SQLContainer.Query = @"SELECT [Length],Width,Height,Quantity,Area FROM Scopes_in_Renovations 
        //                           INNER JOIN Options ON Options.OptionID=Scopes_in_Renovations.OptionID AND SystemAddOn=0
        //                           WHERE RenovationID=" + Session["RenovationID"].ToString() + " AND  Scopes_in_Renovations.ScopeID=" + Session["ScopeID"].ToString();
        //    List<SqlParameter> SqlParameters = new List<SqlParameter>();
        //    SQLCommands.Add(SQLContainer);
        //}
        if (!Tools.GetData(SQLCommands, out DS, out ErrorIfAny))
        ...
        else
        {
            ...
            //if (DS.Tables[1].Rows.Count > 0)
            //{
            //    TxtLength.Text = DS.Tables[1].Rows[0]["Length"].ToString();
            //    TxtWidth.Text = DS.Tables[1].Rows[0]["Width"].ToString();
            //    TxtHeight.Text = DS.Tables[1].Rows[0]["Height"].ToString();
            //    TxtQuantity.Text = DS.Tables[1].Rows[0]["Quantity"].ToString();
            //    TxtArea.Text = DS.Tables[1].Rows[0]["Area"].ToString();
            //    hdnArea.Value = DS.Tables[1].Rows[0]["Area"].ToString();
            //}
            //else
            //{
        ...
        try
        {
            if (Session["OptionID"] != null)
            {
                ...
                else
                {
                    if (DS.Tables[0].Rows.Count > 0)
                    {
                        //LblOptionName.Text = DS.Tables[1].Rows[0]["Option"].ToString();
    ...
    public void LoadItemMeasurements()
    {
        try
        {
            ...
            else
            {
                ...
                RoomTotalCost(RoomPreferenceID, SubsubOptionL3ID, Quantity, Area);
                getProjectCost();
            }
        }
        catch (Exception eX) { }
    ...
    public void CreateORUpdateRenovation()
    {
        ...
        {
            Tools.SqlContainer SQLContainer = new Tools.SqlContainer();
            SQLContainer.Query = "CreateORUpdateRenovationTest @OptionID, @SubOptionID, @SubSubOptionID, @SubSubOptionL2ID, @SubSubOptionL3ID, @Length, @Width, @Height, " +
        ...
        if (Tools.GetData(SQLCommand, out DsRenovations, out ErrorIfAny))
        {
            ...
            //Session["EditRenovationID"] = Session["RenovationID"].ToString();
            GetRoooms();
        }
    }
    ...
    public void SaveProjectCost()
    {
        try
        {
            ...
            {
                Tools.SqlContainer SQLContainer = new Tools.SqlContainer();
                SQLContainer.Query = "ProjectCostUpdateTest @ProjectID";
                List<SqlParameter> SqlParameters = new List<SqlParameter>();
    ...
    protected void txtLength_TextChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                //int Length = Convert.ToInt32(Convert.ToInt32(txtLength.Text) * mmValue);
                //int width = Convert.ToInt32(Convert.ToInt32(txtWidth.Text) * mmValue);
                double Length = Convert.ToDouble(txtLength.Text);
                double width = Convert.ToDouble(txtWidth.Text);
                txtArea.Text = Convert.ToString(Convert.ToDecimal(txtLength.Text) * Convert.ToDecimal(txtWidth.Text));
                //lblAreamm.Text = Convert.ToString(Length * width);
                //lblAreaft.Text = Convert.ToString(Math.Round(Convert.ToDouble(txtArea.Text) / mmValue, 2));
            ...
            if (txtLength.Text != string.Empty)
            {
                //lblLengthmm.Text = Convert.ToString(Convert.ToInt32(txtLength.Text) * mmValue);
                lblLengthft.Text = Convert.ToString(Math.Round(Convert.ToDouble(txtLength.Text) / mmValue, 2));
            }
            if (txtWidth.Text != string.Empty)
            {
                //lblWidthmm.Text = Convert.ToString(Convert.ToInt32(txtWidth.Text) * mmValue);
    ...
    public void RoomTotalCost(int RoomPreferenceID, int SubsubOptionL3ID, int Quantity, string Area)
    {
        try
        {
            string ErrorIfAny = string.Empty;
        ...
        try
        {
            ...
            else
            {
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    //sbImageSlider.Append("<div class='modal fade hnm-img-slider' id='imgSlider"
                    //                        + "tabindex ='-1' aria-labelledby='imgSliderLabel' aria-hidden='true'>"
                    //                        + "<div class='modal-dialog'>"
                    //                        + "<div class='modal-content'>"
                    //                        + "<div class='modal-body'>"
                    ...
                    //for (int j = 0; j <= ds.Tables[0].Rows.Count - 1; j++)
                    //{
                    //    sbImageThemeOme.Append("<div class='hnm-img-slider__for-item zoom-box'>"
                    //                            + "<img src='" + Convert.ToString(ds.Tables[0].Rows[j]["Thumbnail"]) + "' alt='' />"
                    //                            + "</div>");
                    //}
                    //sbImageSlider.Append("</div>"
                    ...
                    //    if (j == 0)
                    //    {
                    //        sbImageThemeZoom.Append("<div class='hnm-img-slider__nav-item zoomThumbActive'>");
                    //    }
                    //    else
                    //    {
                    //        sbImageThemeZoom.Append("<div class='hnm-img-slider__nav-item'>");
                    //    }
                    //    sbImageThemeZoom.Append("<img src='" + Convert.ToString(ds.Tables[0].Rows[j]["Thumbnail"]) + "' alt='' />"
                    //                            + "</div>");
                    //}
                    //sbImageSlider.Append("</div>"
                    //                       + "</div>"
                    ...
                    //litThemeImageSilderPopUp.Text = litThemeImageSilderPopUp.Text + sbImageSlider.ToString();
                    //litThemesOne.Text = litThemesOne.Text + sbImageThemeOme.ToString();
                    //litThemesZoom.Text = litThemesZoom.Text + sbImageThemeZoom.ToString();
                    sbbottomdiv.Append("<div class='modal-backdrop fade show'></div>");
