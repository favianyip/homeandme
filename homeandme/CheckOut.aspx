...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="hnm-checkout">
        <div class="content-wrapper">
            ...
            <div class="hnm-doc-box">
                ...
                <div class="hnm-doc-box__inner">
                    ...
                    <div class="hnm-doc-box__sec-2">
                        <p class="hnm-doc-box__text">Forms can be submitted online</p>
                                    ...
                                    <ContentTemplate>
                                        <p class="hnm-doc-box__download">
                                            ...
                                            <%--<asp:LinkButton ID="lnkDocumentForm" runat="server" CssClass="hnm-doc-box__download-link" CommandArgument='<%# Eval("ItemFileURL") %>' OnClick="lnkDocumentForm_Click">
                                             ...
                                             <a href='<%# Eval("ItemFileURL") %>' CssClass="hnm-doc-box__download-link" target="_blank" > Click Here</a>
                                        </p>
                                    </ContentTemplate>
                                  <%--  <Triggers>
            ...
            <asp:UpdatePanel ID="upLoanSection" runat="server">
                <ContentTemplate>
                    <div class="hnm-checkout__wrapper">
                                ...
                                <div class="hnm-checkout__loan-outer">
                                    <div class="hnm-checkout__loan-slider">
                                        <dx:ASPxTrackBar ID="LoanAmountTrackBar" runat="server" AutoPostBack="true" Height="50px"
                                            LargeTickInterval="20000" MaxValue="100000" MinValue="0" PositionEnd="100000" PositionStart="0"
                                    ...
                                    <asp:UpdatePanel ID="upLoanAmount" runat="server" UpdateMode="Always">
                                        <ContentTemplate>
                                        ...
                                        <asp:UpdatePanel ID="upBanks" runat="server" UpdateMode="Always">
                                            <ContentTemplate>
                                                <p class="hnm-doc-box__download">
                                                    <%# Eval("ItemText") %>
                                                    <a href='<%# Eval("ItemFileURL") %>' CssClass="hnm-doc-box__download-link" target="_blank" > Click Here</a>
                                                   <%-- <asp:LinkButton ID="btnBankForm" runat="server" Text="Click Here" 
                                                        CssClass="hnm-doc-box__download-link" CommandArgument='<%# Eval("ItemFileURL") %>' 
                                                        OnClientClick="target ='_blank';" OnClick="btnBankForm_Click"></asp:LinkButton>--%>
                                                </p>
                                            </ContentTemplate>
                                          <%--  <Triggers>
                        ...
                        <div class="hnm-checkout__date-outer">
                            <div class="hnm-checkout__title">Select your preferred timeslot for Subcontractor visit</div>
                            ...
                            <div class="hnm-checkout__btn">
                                <asp:LinkButton ID="lnkProceed" runat="server" CssClass="hnm-button hnm-button--secondary" ValidationGroup="address" CausesValidation="true" OnClick="lnkProceed_Click">PROCEED TO CHECKOUT</asp:LinkButton>
                            </div>
                        </div>
                    </div>
                </ContentTemplate>
