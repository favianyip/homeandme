                ...
                <div class="content-wrapper">
                    <div class="hnm-login__wrapper">
                        <div class="hnm-login__box">
                            ...
                            <div class="hnm-input">
                                <p class="hnm-input__text-label">Your Phone Number*</p>
                            ...
                            <div class="hnm-login__btn-sec">
                                <div class="hnm-login__btn-left">
                                    <asp:LinkButton ID="lnkSignUp" runat="server" CssClass="hnm-button" CausesValidation="true" ValidationGroup="SignUp" OnClick="lnkSignUp_Click">Sign Up</asp:LinkButton>
                                </div>
